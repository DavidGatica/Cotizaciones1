...
while ($campo = mysql_fetch_array($resultado)) {
	...
	$id_catalogooficial = $campo['id_catalogo'];
    $unidad = $campo['unidad'];
    ...
    <body>
        <div id="page">
            ...
            <div id="modificar">
                ...
                <form action="cambioproducto2.php" method="GET">
				
				<td><br><input type="text"  style="color:#272B46; width:900px; height:1px; background:#272B46; border: 0;  "  name="id_catalogooficial" value="<?php echo$id_catalogooficial; ?>" ></td>

                    <table align="center" border=0 id="tablacambio" cellspacing="5">

                        <tr>
						<td>Cat&aacute;logo<br><input type="text"   class="formu" name="id_catalogo" value="<?php echo$id_catalogo; ?>" disabled ></td>
