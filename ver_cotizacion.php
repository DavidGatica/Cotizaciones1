                                ...
                                <td height="33.3%" width="14%" id="bordet">
                                    <div align="center">
                                        <table>
                                            ...
                                            <tr><td width="50%" align=right class="h7">
                                                    Vigencia en Días: </td><td align=center width="50px" class="h7"><?php echo $vigencia; ?>
                                                </td></tr>

                                            <tr><td width="50%" align=right class="h7">
                                                    Partidas: </td><td align=center width="50px" class="h7"><?php echo $no_partidas; ?></td></tr>
...
?>
                                    ...
                                    <td>
                                        <br>
                                        <div class="precios">Divisa</div><HR width=100% align="left"><br>
                                        <div class="precios">Subtotal </div><HR width=100% align="left"><br>
                                        <?php if ($descuento > 0) { ?>
                                            <div class="precios">Descuento </div><HR width=100% align="left"><br>
                                            <div class="precios">Subtotal con desc </div><HR width=100% align="left"><br>
                                        <?php } ?>
                                        <div class="precios">I.V.A. </div><HR width=100% align="left"><br>
                                       <div class="precios">Total </div>
                                    </td>
