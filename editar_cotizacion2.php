...
$sql = "UPDATE `Cotizaciones` SET fecha='$fecha', vigencia='$vigencia',`no_partidas`='$no_partidas1', `divisa`='$divisa',`subtotal`='$subtotal',`iva`='$iva',`total`='$total',`t_entrega`='$t_entrega',`c_pago`='$c_pago' WHERE `id_cotizacion`='$id_cotizacion'";
...
//Agregar Campos en la Tabla Cotizaciones
$sqla = "UPDATE `Datos_Cotizacion` SET datos_cliente='$string',`datos_contacto`='$string2',`datos_vendedor`='$string3' WHERE `id_cotizacion`='$id_cotizacion'";
